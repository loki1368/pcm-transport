...
bool M3uPlaylistExtensions::looks_like_playlist_path(const std::string& path) {
...
std::vector<M3uPlaylistEntry> M3uPlaylistExtensions::read_entries(const std::string& path) {
